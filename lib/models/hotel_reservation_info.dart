...
//
//     final hotelReserve = hotelReserveFromJson(jsonString);

import 'dart:convert';

HotelReserve hotelReserveFromJson(String str) => HotelReserve.fromJson(json.decode(str));

String hotelReserveToJson(HotelReserve data) => json.encode(data.toJson());
...
class HotelReserve {
  ...
  factory HotelReserve.fromJson(Map<String, dynamic> json) => HotelReserve(
    id: json["id"],
